...
namespace FarmerbotWebUI.Client.Services.EventConsole
{
    public interface IEventConsoleService
    {
        ...
        public EventSourceActionId AddMessage(EventSourceActionId id, string title, string message, bool? showProgressBar, bool? done, bool? showInGui, LogLevel level, EventResult result);
        public EventSourceActionId AddMessage(EventMessage message);
        public void UpdateMessage(EventSourceActionId id, string? title, string? message, bool? showProgressBar, bool? done, bool? showInGui, LogLevel? level, EventResult? result);
